...
import {
    ArrowLeft, UploadCloud, Maximize2, CheckCircle, Download,
    Settings, Image as ImageIcon, Sparkles, Lock, Unlock, Percent, Type,
    X, Loader2, DownloadCloud, AlertCircle
} from 'lucide-react';
                ...
                <div className="w-full lg:w-[350px] order-1 lg:order-2 shrink-0">
                    <div className="bg-white rounded-3xl shadow-xl border border-gray-100 p-6 sticky top-6">
                      ...
                      ${isProcessingAll || (!targetWidth && !targetHeight && resizeMode === 'pixels')
                                ...
                                >
                                    {isProcessingAll ? <Loader2 className="w-5 h-5 animate-spin" /> : <Maximize2 className="w-5 h-5" />}
